...
module Deliver
  ...
  class AppScreenshot
    ...
    module ScreenSize
      ...
      # iPad Pro 13-inch (M4)
      IOS_IPAD_PRO_13_1 = "iOS-iPad-Pro-13"
    ...
    def device_type
      matching = {
        ...
        ScreenSize::IOS_IPAD_PRO_13_1 => Spaceship::ConnectAPI::AppScreenshotSet::DisplayType::APP_IPAD_PRO_3GEN_129,
    ...
    def formatted_name
      matching = {
        ...
        ScreenSize::IOS_IPAD_PRO_13_1 => "iPad Pro 13-inch (M4)",
